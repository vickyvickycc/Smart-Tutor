...
try
{
	...
	if(request.getParameter("btn_login")!=null) //check login button click event not null
	{
		...
		if(rs.next())
		{
			...
			{
				session.setAttribute("admin",dbemail); //session name is login and store fetchable database email address
				response.sendRedirect("add_student.jsp"); //after login success redirect to welcome.jsp page
			}
		}
		else
		{
...
<body>
	<div class="header" style="background-color: #4B0082">
		...
		<button type="button" class="btn btn-light"><a href="index.jsp"><b>Student</b></a></button>
		</div>
	</div><br>
<!--login form-->
